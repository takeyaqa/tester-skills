...
- Requires Node.js and npm access to execute `npx pict-cli@0.2`.
...
- Run `npx pict-cli@0.2 <model-file>`.
  - When file creation is unnecessary or piping is more convenient, send the model through stdin with `npx pict-cli@0.2 -`.
    - Example: `printf '%s\n' '...model text...' | npx pict-cli@0.2 -`
