...
- Requires Node.js and npm access to execute `npx pict-cli@0.2.5`.
...
- Run `npx pict-cli@0.2.5 <model-file>`.
  - When file creation is unnecessary or piping is more convenient, send the model through stdin with `npx pict-cli@0.2.5 -`.
    - Example: `printf '%s\n' '...model text...' | npx pict-cli@0.2.5 -`
